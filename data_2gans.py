...
def mnist_data_providers(args, batch_size, crop_size=[], use_test_set=False, args):
    if isinstance(crop_size, int): crop_size = [crop_size]
    from load import mnist_with_valid_set
    trX, vaX, teX, trY, vaY, teY = mnist_with_valid_set(args)
    if use_test_set:
...
class Dataset(object):
    def __init__(self, args):
        ...
        if args.dataset == 'mnist':
            ...
            providers = mnist_data_providers(args, args.batch_size, crop_size=crop_sizes,
